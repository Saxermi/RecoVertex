...
// used in vertices in blocks zombie
...
// DA in blocks
vector<TransientVertex> DAClusterizerInZ_vect::vertices_in_blocks(const VertexProtoType VertexCandiates, const vector<reco::TransientTrack>& tracks) const {
